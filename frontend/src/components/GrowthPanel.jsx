...
const ACR_IMPACT_COLOR = { high: "#22c55e", medium: "#3b82f6", low: "#64748b" };
      ...
      <div style={{ display: "flex", gap: 28, flexWrap: "wrap", alignItems: "flex-start" }}>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
            ...
            <span style={{ color: "#475569", fontSize: 14 }}>opportunities across {categories.length} service categories</span>
            <span style={{
          ...
          <div style={{ marginTop: 14, color: "#475569", fontSize: 11, lineHeight: 1.6 }}>
            Each category represents an Azure service that is <strong style={{ color: "#94a3b8" }}>not yet adopted</strong> by
    ...
    <div style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(175px, 1fr))", gap: 10 }}>
        {categories.map((cat) => {
          ...
          const impactColor = ACR_IMPACT_COLOR[cat.acr_impact] || "#64748b";
          return (
            <div
            ...
            >
              ...
              <div style={{ color: "#e2e8f0", fontSize: 11, fontWeight: 600, marginBottom: 6, lineHeight: 1.3 }}>
                {cat.category}
              </div>
              {/* Progress bar */}
...
function ACRGapCard({ gap }) {
  ...
  const impactColor = ACR_IMPACT_COLOR[gap.acr_impact] || "#64748b";
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ color: "#475569", fontSize: 10, marginBottom: 6 }}>
            ...
            {gap.resource_monthly_cost > 0 && (
              <>
                <span style={{ color: "#334155", margin: "0 5px" }}>·</span>
                <span style={{ color: "#64748b" }}>💰 ${Math.round(gap.resource_monthly_cost).toLocaleString()}/mo resource</span>
              </>
            )}
          </div>
    ...
    <div style={{ fontFamily: "inherit" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 4, alignItems: "center", borderLeft: "1px solid #1e293b", paddingLeft: 10 }}>
          <span style={{ color: "#475569", fontSize: 10, fontWeight: 700, textTransform: "uppercase", marginRight: 4 }}>ACR Impact:</span>
          {[["all","All"],["high","High"],["medium","Medium"],["low","Low"]].map(([v,l]) => {
            const c = ACR_IMPACT_COLOR[v] || "#64748b";
            return (
