...
const REPORT_SECTIONS = {
  ...
  cost_variance:       ['movers', 'spend_overview', 'subscriptions', 'service_categories', 'anomalies'],
  chargeback:          ['allocation', 'governance', 'subscriptions', 'resource_groups', 'spend_overview'],
  ai_spend:            ['service_categories', 'subscriptions', 'movers', 'savings_roi', 'spend_overview'],
...
const REPORT_TYPES = [
  ...
  { key: 'cost_variance', label: 'Cost Change & Variance', Icon: TrendingUp, color: '#f43f5e', group: 'Core',
    desc: 'Why spend moved, not what it is \u2014 attributed to new, grown, shrunk and retired workloads.' },
  { key: 'chargeback',   label: 'Chargeback Statement', Icon: Wallet, color: '#a855f7', group: 'Core',
    desc: 'Invoice-style breakdown per cost centre, plus the unallocated spend nobody can be billed for.' },
  { key: 'ai_spend',     label: 'AI & Machine Learning Spend', Icon: Rocket, color: '#8b5cf6', group: 'Management Review',
    desc: 'OpenAI, Cognitive Services, Foundry and ML spend, its share of the estate and its growth rate.' },
